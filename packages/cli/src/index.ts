...
/**
 * @minions-bundles-agency/cli — CLI for Minions Bundle: Agency
 *
...
import { bundleTypes as customTypes } from '@minions-bundles-agency/sdk';
...
program
    .name('minions-bundles-agency')
    .description('Full-stack IT agency bundle — prospecting, outreach, CRM pipeline, delivery, billing, and client management for productized service businesses')
    .version('0.1.0');
...
program
    ...
    .action(() => {
        console.log(chalk.bold('Minions Bundle: Agency'));
        console.log(chalk.dim('Full-stack IT agency bundle — prospecting, outreach, CRM pipeline, delivery, billing, and client management for productized service businesses'));
        console.log('');
        console.log(`  SDK:      ${chalk.cyan('@minions-bundles-agency/sdk')}`);
        console.log(`  CLI:      ${chalk.cyan('@minions-bundles-agency/cli')}`);
        console.log(`  Python:   ${chalk.cyan('minions-bundles-agency')}`);
