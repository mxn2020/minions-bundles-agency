# Manual Setup Steps for Minions Bundle: Agency
...
Go to **GitHub → mxn2020/minions-bundles-agency → Settings → Secrets and variables → Actions** and add:
...
### Web App (Playground)
- **Netlify site name**: `minions-bundles-agency-web`
- **GitHub repo**: `mxn2020/minions-bundles-agency`
...
### Documentation
- **Netlify site name**: `minions-bundles-agency-docs`
- **GitHub repo**: `mxn2020/minions-bundles-agency`
...
### Blog
- **Netlify site name**: `minions-bundles-agency-blog`
- **GitHub repo**: `mxn2020/minions-bundles-agency`
...
|--------|------|------|-------|
| Docs | CNAME | `agency.minions.help` | _(Netlify subdomain)_ |
| Blog | CNAME | `agency.minions.blog` | _(Netlify subdomain)_ |
| App  | CNAME | `agency.minions.wtf` | _(Netlify subdomain)_ |
...
| Item | Value |
|------|-------|
| Project | `minions-bundles-agency` |
| SDK (npm) | `undefined` |
| CLI (npm) | `undefined` |
| Python (PyPI) | `undefined` |
| GitHub | `github.com/mxn2020/minions-bundles-agency` |
